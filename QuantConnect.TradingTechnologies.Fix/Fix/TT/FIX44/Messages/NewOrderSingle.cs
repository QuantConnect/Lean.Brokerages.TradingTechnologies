    ...
    namespace Messages
    {
        public class NewOrderSingle : Message
        {
            ...
            public NewOrderSingle(
                    ClOrdID aClOrdID,
                    SecurityExchange aSecurityExchange,
                    Account aAccount,
                    OrderQty aOrderQty,
                    Side aSide,
                    OrdType aOrdType
            ...
            public SecondaryAccount SecondaryAccount
            { 
                get 
                {
                    SecondaryAccount val = new SecondaryAccount();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(SecondaryAccount val) 
            { 
                this.SecondaryAccount = val;
            }
            
            public SecondaryAccount Get(SecondaryAccount val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(SecondaryAccount val) 
            { 
                return IsSetSecondaryAccount();
            }
            
            public bool IsSetSecondaryAccount() 
            { 
                return IsSetField(Fields.CustomTags.SecondaryAccount);
            }
            public Price Price
            { 
                get 
            ...
            public ETAGoToMktTicks ETAGoToMktTicks
            { 
                get 
                {
                    ETAGoToMktTicks val = new ETAGoToMktTicks();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(ETAGoToMktTicks val) 
            { 
                this.ETAGoToMktTicks = val;
            }
            
            public ETAGoToMktTicks Get(ETAGoToMktTicks val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(ETAGoToMktTicks val) 
            { 
                return IsSetETAGoToMktTicks();
            }
            
            public bool IsSetETAGoToMktTicks() 
            { 
                return IsSetField(Fields.CustomTags.ETAGoToMktTicks);
            }
            public WaitingOption WaitingOption
            { 
                get 
                {
                    WaitingOption val = new WaitingOption();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(WaitingOption val) 
            { 
                this.WaitingOption = val;
            }
            
            public WaitingOption Get(WaitingOption val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(WaitingOption val) 
            { 
                return IsSetWaitingOption();
            }
            
            public bool IsSetWaitingOption() 
            { 
                return IsSetField(Fields.CustomTags.WaitingOption);
            }
            public TTStopChildTIFOverride TTStopChildTIFOverride
            { 
                get 
                {
                    TTStopChildTIFOverride val = new TTStopChildTIFOverride();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(TTStopChildTIFOverride val) 
            { 
                this.TTStopChildTIFOverride = val;
            }
            
            public TTStopChildTIFOverride Get(TTStopChildTIFOverride val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(TTStopChildTIFOverride val) 
            { 
                return IsSetTTStopChildTIFOverride();
            }
            
            public bool IsSetTTStopChildTIFOverride() 
            { 
                return IsSetField(Fields.CustomTags.TTStopChildTIFOverride);
            }
