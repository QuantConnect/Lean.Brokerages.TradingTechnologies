...
namespace QuantConnect.Fix.TT.FIX44
{
    namespace Messages
    {
        public class MarketDataRequest : Message
        {
            ...
            {
                this.Header.SetField(new MsgType("V"));
            }
            ...
            { 
                get 
                {
                    MarketDepth val = new MarketDepth();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(MarketDepth val) 
            { 
                this.MarketDepth = val;
            }
            
            public MarketDepth Get(MarketDepth val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(MarketDepth val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.MarketDepth);
            }
            public MDUpdateType MDUpdateType
            { 
                get 
                {
                    MDUpdateType val = new MDUpdateType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(MDUpdateType val) 
            { 
                this.MDUpdateType = val;
            }
            
            public MDUpdateType Get(MDUpdateType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(MDUpdateType val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.MDUpdateType);
            }
            public AggregatedBook AggregatedBook
            { 
                get 
                {
                    AggregatedBook val = new AggregatedBook();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(AggregatedBook val) 
            { 
                this.AggregatedBook = val;
            }
            
            public AggregatedBook Get(AggregatedBook val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(AggregatedBook val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.AggregatedBook);
            }
            public NoMDEntryTypes NoMDEntryTypes
            { 
                get 
                {
                    NoMDEntryTypes val = new NoMDEntryTypes();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(NoMDEntryTypes val) 
            { 
                this.NoMDEntryTypes = val;
            }
            
            public NoMDEntryTypes Get(NoMDEntryTypes val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(NoMDEntryTypes val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.NoMDEntryTypes);
            }
            ...
            public IncludeNumberOfOrders IncludeNumberOfOrders
            { 
                get 
                {
                    IncludeNumberOfOrders val = new IncludeNumberOfOrders();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(IncludeNumberOfOrders val) 
            { 
                this.IncludeNumberOfOrders = val;
            }
            
            public IncludeNumberOfOrders Get(IncludeNumberOfOrders val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(IncludeNumberOfOrders val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.IncludeNumberOfOrders);
            }
            public IncludeQuotes IncludeQuotes
            { 
                get 
                {
                    IncludeQuotes val = new IncludeQuotes();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(IncludeQuotes val) 
            { 
                this.IncludeQuotes = val;
            }
            
            public IncludeQuotes Get(IncludeQuotes val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(IncludeQuotes val) 
            { 
                return IsSetIncludeQuotes();
            }
            
            public bool IsSetIncludeQuotes() 
            { 
                return IsSetField(Fields.CustomTags.IncludeQuotes);
            }
            public class NoMDEntryTypesGroup : Group
            {
                public static int[] fieldOrder = {Fields.CustomTags.MDEntryType, 0};
            
                public NoMDEntryTypesGroup() 
                  :base( Fields.CustomTags.NoMDEntryTypes, Fields.CustomTags.MDEntryType, fieldOrder)
                {
                }
            ...
            {
                public static int[] fieldOrder = {Fields.CustomTags.Symbol, Fields.CustomTags.SecurityType, Fields.CustomTags.SecuritySubType, Fields.CustomTags.MaturityMonthYear, Fields.CustomTags.MaturityDate, Fields.CustomTags.MaturityDay, Fields.CustomTags.PutOrCall, Fields.CustomTags.StrikePrice, Fields.CustomTags.OptAttribute, Fields.CustomTags.DeliveryTerm, Fields.CustomTags.DeliveryDate, Fields.CustomTags.SecurityID, Fields.CustomTags.SecurityExchange, Fields.CustomTags.ExDestination, Fields.CustomTags.CFICode, Fields.CustomTags.IDSource, Fields.CustomTags.NoSecurityAltID, Fields.CustomTags.NoLegs, 0};
