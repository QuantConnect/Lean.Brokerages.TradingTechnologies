...
namespace QuantConnect.Fix.TT.FIX44
{
    namespace Messages
    {
        public class MarketDataIncrementalRefresh : Message
        {
            ...
            {
                this.Header.SetField(new MsgType("X"));
            }
            ...
            public ExchangeSendingTime ExchangeSendingTime
            { 
                get 
                {
                    ExchangeSendingTime val = new ExchangeSendingTime();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(ExchangeSendingTime val) 
            { 
                this.ExchangeSendingTime = val;
            }
            
            public ExchangeSendingTime Get(ExchangeSendingTime val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(ExchangeSendingTime val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.ExchangeSendingTime);
            }
            public ExchangeTransactTime ExchangeTransactTime
            { 
                get 
                {
                    ExchangeTransactTime val = new ExchangeTransactTime();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(ExchangeTransactTime val) 
            { 
                this.ExchangeTransactTime = val;
            }
            
            public ExchangeTransactTime Get(ExchangeTransactTime val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(ExchangeTransactTime val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.ExchangeTransactTime);
            }
            public ExchangeSeqNum ExchangeSeqNum
            { 
                get 
                {
                    ExchangeSeqNum val = new ExchangeSeqNum();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(ExchangeSeqNum val) 
            { 
                this.ExchangeSeqNum = val;
            }
            
            public ExchangeSeqNum Get(ExchangeSeqNum val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(ExchangeSeqNum val) 
            { 
            ...
            { 
                return IsSetField(Fields.CustomTags.ExchangeSeqNum);
            }
            public class NoMDEntriesGroup : Group
            {
                public static int[] fieldOrder = {Fields.CustomTags.MDUpdateAction, Fields.CustomTags.MDEntryType, Fields.CustomTags.Symbol, Fields.CustomTags.SecurityDesc, Fields.CustomTags.Product, Fields.CustomTags.SecurityType, Fields.CustomTags.SecuritySubType, Fields.CustomTags.MaturityMonthYear, Fields.CustomTags.MaturityDate, Fields.CustomTags.MaturityDay, Fields.CustomTags.PutOrCall, Fields.CustomTags.StrikePrice, Fields.CustomTags.OptAttribute, Fields.CustomTags.DeliveryTerm, Fields.CustomTags.DeliveryDate, Fields.CustomTags.SecurityID, Fields.CustomTags.SecurityExchange, Fields.CustomTags.ExDestination, Fields.CustomTags.CFICode, Fields.CustomTags.Currency, Fields.CustomTags.MDEntryPx, Fields.CustomTags.MDEntrySize, Fields.CustomTags.MDEntryDate, Fields.CustomTags.MDEntryTime, Fields.CustomTags.MDEntryPositionNo, Fields.CustomTags.SecondaryOrderID, Fields.CustomTags.NumberOfOrders, 0};
            
                public NoMDEntriesGroup() 
                  :base( Fields.CustomTags.NoMDEntries, Fields.CustomTags.MDUpdateAction, fieldOrder)
                {
                }
                ...
                { 
                    get 
                    {
                        MDUpdateAction val = new MDUpdateAction();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(MDUpdateAction val) 
                { 
                    this.MDUpdateAction = val;
                }
                
                public MDUpdateAction Get(MDUpdateAction val) 
                { 
                    GetField(val);
                    return val;
                }
                
                public bool IsSet(MDUpdateAction val) 
                { 
                ...
                { 
                    return IsSetField(Fields.CustomTags.MDUpdateAction);
                }
